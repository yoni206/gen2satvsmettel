...
public class LukasiewiczProblemAnalyzer{
    ...
    public LukasiewiczProblemAnalyzer(String problemFile) throws IOException, RecognitionException{
        this(new FileInputStream(problemFile));
    }

    public LukasiewiczProblemAnalyzer(InputStream problemReader) throws IOException, RecognitionException{
        ...
        ArrayList<LukasiewiczExpression> list = parser.expressions();

        for (LukasiewiczExpression expression : list){
    ...
    private void determineSymbol(LukasiewiczExpression expression){
        currentDepth++;
        if (expression instanceof Lukasiewicz_valuation){
            if (expression instanceof Lukasiewicz_valuationVariable){
                Integer value;
                String variableName = ((Lukasiewicz_valuationVariable)expression).toString();
            ...
            }else if (expression instanceof Lukasiewicz_true_valuation){
                update_valuationConnectiveOccurences("true");
                update_valuationConnectiveMaxDepth("true");
                determineSymbol(((Lukasiewicz_true_valuation)expression).e0);
            }else if (expression instanceof Lukasiewicz_unknown_valuation){
                update_valuationConnectiveOccurences("unknown");
                update_valuationConnectiveMaxDepth("unknown");
                determineSymbol(((Lukasiewicz_unknown_valuation)expression).e0);
            }else if (expression instanceof Lukasiewicz_false_valuation){
                update_valuationConnectiveOccurences("false");
                update_valuationConnectiveMaxDepth("false");
                determineSymbol(((Lukasiewicz_false_valuation)expression).e0);
            }
        }else         if (expression instanceof Lukasiewicz_formula){
            if (expression instanceof Lukasiewicz_formulaVariable){
                Integer value;
                String variableName = ((Lukasiewicz_formulaVariable)expression).toString();
            ...
            }else if (expression instanceof Lukasiewicz_negation_formula){
                update_formulaConnectiveOccurences("negation");
                update_formulaConnectiveMaxDepth("negation");
                determineSymbol(((Lukasiewicz_negation_formula)expression).e0);
            }else if (expression instanceof Lukasiewicz_conjunction_formula){
                update_formulaConnectiveOccurences("conjunction");
                update_formulaConnectiveMaxDepth("conjunction");
                determineSymbol(((Lukasiewicz_conjunction_formula)expression).e0);
                determineSymbol(((Lukasiewicz_conjunction_formula)expression).e1);
            }else if (expression instanceof Lukasiewicz_disjunction_formula){
                update_formulaConnectiveOccurences("disjunction");
                update_formulaConnectiveMaxDepth("disjunction");
                determineSymbol(((Lukasiewicz_disjunction_formula)expression).e0);
                determineSymbol(((Lukasiewicz_disjunction_formula)expression).e1);
            }else if (expression instanceof Lukasiewicz_implication_formula){
                update_formulaConnectiveOccurences("implication");
                update_formulaConnectiveMaxDepth("implication");
                determineSymbol(((Lukasiewicz_implication_formula)expression).e0);
                determineSymbol(((Lukasiewicz_implication_formula)expression).e1);
            }
        }
        currentDepth--;
    }
    ...
    public int unknown_valuationOccurences(){
        Integer result = valuationConnectivesOccurences.get("unknown");
        return result == null ? 0 : result;
    }

    public int unknown_valuationMaxDepth(){
        Integer result = valuationConnectivesMaxDepth.get("unknown");
        return result == null ? UNLISTED_DEPTH : result;
    }
    ...
    public Properties getStatistics(){
        ...
        st.setProperty("valuation.unknown.occurences", String.valueOf(unknown_valuationOccurences()));
        st.setProperty("valuation.unknown.max-depth", String.valueOf(unknown_valuationMaxDepth()));
