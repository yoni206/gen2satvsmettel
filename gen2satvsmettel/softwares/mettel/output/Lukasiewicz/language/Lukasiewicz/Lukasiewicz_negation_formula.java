...
public class Lukasiewicz_negation_formula extends LukasiewiczAbstractExpression implements Lukasiewicz_formula{

    static final int PRIORITY = 4;
    private final int LENGTH;
    protected Lukasiewicz_formula e0 = null;

    public Lukasiewicz_negation_formula(Lukasiewicz_formula e0, LukasiewiczObjectFactory f){
        super(f);
        int l = 1;
        this.e0 = e0;
        l += e0.length();
    ...
    public boolean match(LukasiewiczExpression e, LukasiewiczSubstitution s){
        if(!(e instanceof Lukasiewicz_negation_formula)){ return false;}
        final Lukasiewicz_negation_formula ee = (Lukasiewicz_negation_formula)e;
        return e0.match(ee.e0, s);
    }

    public LukasiewiczExpression substitute(LukasiewiczSubstitution s){
        return factory.create_negation_formula((Lukasiewicz_formula)e0.substitute(s));
    }

    public LukasiewiczExpression rewrite(LukasiewiczReplacement s){
        LukasiewiczExpression e = s.get_formula(this);
        if(e != null){ return e; }
        final Lukasiewicz_formula ee = factory.create_negation_formula((Lukasiewicz_formula)e0.rewrite(s));
        e = s.get_formula(ee);
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof Lukasiewicz_negation_formula)){ return false; }
        Lukasiewicz_negation_formula e = (Lukasiewicz_negation_formula) o;
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof Lukasiewicz_negation_formula)){ return PRIORITY - ((LukasiewiczAbstractExpression)e).priority(); }
        Lukasiewicz_negation_formula ee = (Lukasiewicz_negation_formula) e;
        int result = 0;
