...
import Lukasiewicz.language.Lukasiewicz.Lukasiewicz_valuationVariable;
import Lukasiewicz.language.Lukasiewicz.Lukasiewicz_formula;
import Lukasiewicz.language.Lukasiewicz.Lukasiewicz_formulaVariable;

import Lukasiewicz.language.Lukasiewicz.LukasiewiczObjectFactory;
...
public class LukasiewiczRandomExpressionGenerator implements LukasiewiczExpressionGenerator{
    ...
    private static LukasiewiczRandomExpressionGenerator g = new LukasiewiczRandomExpressionGenerator();

    public static void main(String[] args) {
        System.out.println("-------------------------------------------------------------------");
        System.out.println("Hello there! I am a random expression generator for Lukasiewicz logic.");
    ...
    private static void setProperties() throws IOException{
        ...
        g.set_unknown_valuationFrequency(Integer.parseInt(configuration.getProperty("valuation.unknown.frequency", "1").trim()));
    ...
    private static void outputGeneratedExpressions() throws IOException, RecognitionException{
        ...
        for (int i = 0; i < g.valuationTimesToRun; i++){
            while ((outputFile = new File(outputPath + "/Lukasiewicz_" + fileIndex + ".mtl")).exists()){
                fileIndex++;
            }
            ...
            LukasiewiczProblemAnalyzer expressionAnalyzer = new LukasiewiczProblemAnalyzer(expressionStream);
    ...
    private static void setDefaultProperties(){
        ...
        configuration.setProperty("valuation.unknown.frequency", "1");
    ...
    public LukasiewiczRandomExpressionGenerator() {
        super();
    }

    public LukasiewiczRandomExpressionGenerator(LukasiewiczObjectFactory factory) {
        super();
    ...
    private int unknown_valuationFrequency = 1;

    public void set_unknown_valuationFrequency(int f){
        if(f < 0) throw new MettelCoreRuntimeException("Frequency parameter is negative");
        total_valuationFrequency += (f - unknown_valuationFrequency);
        unknown_valuationFrequency = f;
    }
    ...
    private int total_valuationFrequency = 4;
    ...
    public Lukasiewicz_valuation valuation(){
        if (valuationTopConnectives != null){
            ...
            for (String connective : valuationTopConnectives){
                ...
                if ("unknown".equals(connective)){
                    totalTopConnectivesFrequency += unknown_valuationFrequency;
                }
            ...
            for (String connective : valuationTopConnectives){
                if ("true".equals(connective) && r < true_valuationFrequency){
                    ...
                    if ("unknown".equals(connective) && r < unknown_valuationFrequency){
                        return factory.create_unknown_valuation(formula(depth_valuation-1));
                    }else{
                        if ("unknown".equals(connective))
                            r -= unknown_valuationFrequency;
    ...
    private Lukasiewicz_valuation valuation(int d){
        ...
        if(r < true_valuationFrequency){
            ...
            r -= true_valuationFrequency;
            if(r < unknown_valuationFrequency){
                return factory.create_unknown_valuation(formula(d-1));
            }else{
                r -= unknown_valuationFrequency;
    ...
    public void set_valuationVariables(Collection<Lukasiewicz_valuationVariable> vars){
        if(vars == null) return;
        valuationVariablesSize = vars.size();
        valuationVariables = new String[valuationVariablesSize];
        Lukasiewicz_valuationVariable[] vv = (Lukasiewicz_valuationVariable[]) vars.toArray();
    ...
    protected final Lukasiewicz_valuationVariable valuationVariable(){
    ...
    public Lukasiewicz_formula formula(){
    ...
    private Lukasiewicz_formula formula(int d){
    ...
    public void set_formulaVariables(Collection<Lukasiewicz_formulaVariable> vars){
        if(vars == null) return;
        formulaVariablesSize = vars.size();
        formulaVariables = new String[formulaVariablesSize];
        Lukasiewicz_formulaVariable[] vv = (Lukasiewicz_formulaVariable[]) vars.toArray();
    ...
    protected final Lukasiewicz_formulaVariable formulaVariable(){
