...
public class Lukasiewicz_implication_formula extends LukasiewiczAbstractExpression implements Lukasiewicz_formula{
    ...
    public Lukasiewicz_implication_formula(Lukasiewicz_formula e0, Lukasiewicz_formula e1, LukasiewiczObjectFactory f){
        super(f);
        int l = 1;
        this.e0 = e0;
        l += e0.length();
    ...
    public boolean match(LukasiewiczExpression e, LukasiewiczSubstitution s){
        if(!(e instanceof Lukasiewicz_implication_formula)){ return false;}
        final Lukasiewicz_implication_formula ee = (Lukasiewicz_implication_formula)e;
        return e0.match(ee.e0, s) && e1.match(ee.e1, s);
    }

    public LukasiewiczExpression substitute(LukasiewiczSubstitution s){
        return factory.create_implication_formula((Lukasiewicz_formula)e0.substitute(s), (Lukasiewicz_formula)e1.substitute(s));
    }

    public LukasiewiczExpression rewrite(LukasiewiczReplacement s){
        LukasiewiczExpression e = s.get_formula(this);
        if(e != null){ return e; }
        final Lukasiewicz_formula ee = factory.create_implication_formula((Lukasiewicz_formula)e0.rewrite(s), (Lukasiewicz_formula)e1.rewrite(s));
        e = s.get_formula(ee);
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof Lukasiewicz_implication_formula)){ return false; }
        Lukasiewicz_implication_formula e = (Lukasiewicz_implication_formula) o;
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof Lukasiewicz_implication_formula)){ return PRIORITY - ((LukasiewiczAbstractExpression)e).priority(); }
        Lukasiewicz_implication_formula ee = (Lukasiewicz_implication_formula) e;
        int result = 0;
