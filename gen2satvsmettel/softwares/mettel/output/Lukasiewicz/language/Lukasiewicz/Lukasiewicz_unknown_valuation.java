...
public class Lukasiewicz_unknown_valuation extends LukasiewiczAbstractExpression implements Lukasiewicz_valuation{

    static final int PRIORITY = 2;
    private final int LENGTH;
    protected Lukasiewicz_formula e0 = null;

    public Lukasiewicz_unknown_valuation(Lukasiewicz_formula e0, LukasiewiczObjectFactory f){
        super(f);
        int l = 1;
        this.e0 = e0;
        l += e0.length();
    ...
    public boolean match(LukasiewiczExpression e, LukasiewiczSubstitution s){
        if(!(e instanceof Lukasiewicz_unknown_valuation)){ return false;}
        final Lukasiewicz_unknown_valuation ee = (Lukasiewicz_unknown_valuation)e;
        return e0.match(ee.e0, s);
    }

    public LukasiewiczExpression substitute(LukasiewiczSubstitution s){
        return factory.create_unknown_valuation((Lukasiewicz_formula)e0.substitute(s));
    }

    public LukasiewiczExpression rewrite(LukasiewiczReplacement s){
        LukasiewiczExpression e = s.get_valuation(this);
        if(e != null){ return e; }
        final Lukasiewicz_valuation ee = factory.create_unknown_valuation((Lukasiewicz_formula)e0.rewrite(s));
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof Lukasiewicz_unknown_valuation)){ return false; }
        Lukasiewicz_unknown_valuation e = (Lukasiewicz_unknown_valuation) o;
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof Lukasiewicz_unknown_valuation)){ return PRIORITY - ((LukasiewiczAbstractExpression)e).priority(); }
        Lukasiewicz_unknown_valuation ee = (Lukasiewicz_unknown_valuation) e;
        int result = 0;
