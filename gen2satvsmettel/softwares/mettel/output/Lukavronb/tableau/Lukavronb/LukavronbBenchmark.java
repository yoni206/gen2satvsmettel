 ...
 */
package Lukavronb.tableau.Lukavronb;
...
import Lukavronb.language.Lukavronb.LukavronbLexer;
import Lukavronb.language.Lukavronb.LukavronbParser;
import Lukavronb.language.Lukavronb.LukavronbProblemAnalyzer;
import Lukavronb.language.Lukavronb.LukavronbTableauObjectFactory;

import static mettel.util.MettelStrings.FILE_SEPARATOR;
public class LukavronbBenchmark{
    ...
    final private static LukavronbParser parser = new LukavronbParser(tokens);
    ...
    public static void main(String[] args) throws IOException{
        try{
            ...
            File csvFile = new File(inDir + FILE_SEPARATOR + "Lukavronb.csv");
    ...
    private static MettelProverThread createAndStartNewThread(String problemFile) throws IOException, RecognitionException, InterruptedException{
        for(int i = 0; i < MAX_THREAD_TRIES; i++){
            try{
                ...
                LukavronbTableauObjectFactory tfactory = new LukavronbTableauObjectFactory();
    ...
    private static void updateProblemFile(MettelProverThread thread) throws IOException, RecognitionException{
        ...
        if(!pFile.existsStatisticsProperties()){
            LukavronbProblemAnalyzer pAnalyzer = new LukavronbProblemAnalyzer(problemPath);
            pStat = pAnalyzer.getStatistics();
            pFile.setStatisticsProperties(pStat);
        }else{
            pStat = pFile.getStatisticsProperties();
        }
        pFile.addStatusProperty("LukavronbProver", thread.result() == null? CSV_NOT_RELEVANT_FIELD: (thread.result()? "Satisfiable":"Unsatisfiable"));
        pFile.writeToFile();
    }
    ...
    public static void parseCalculus(Set<MettelGeneralTableauRule> calculus) throws IOException, RecognitionException{
        CharStream tin = new ANTLRInputStream(LukavronbBenchmark.class.getResourceAsStream("calculus"));
        tokens.setTokenSource(new LukavronbLexer(tin));
