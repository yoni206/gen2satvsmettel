...
public class LukavronbTableauProver{
    ...
    public static void main(String[] args) {
        System.out.println("-------------------------------------------------------------------");
        System.out.println("Hello there! I am an automated tableau prover for Lukavronb logic.");
    ...
    throws IOException, RecognitionException{
        CharStream tin = (path == null)?
            new ANTLRInputStream(LukavronbTableauProver.class.getResourceAsStream("calculus")):
