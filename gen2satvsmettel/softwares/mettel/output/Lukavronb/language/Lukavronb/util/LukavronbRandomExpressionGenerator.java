...
import Lukavronb.language.Lukavronb.Lukavronb_valuationVariable;
import Lukavronb.language.Lukavronb.Lukavronb_formula;
import Lukavronb.language.Lukavronb.Lukavronb_formulaVariable;

import Lukavronb.language.Lukavronb.LukavronbObjectFactory;
...
public class LukavronbRandomExpressionGenerator implements LukavronbExpressionGenerator{
    ...
    private static LukavronbRandomExpressionGenerator g = new LukavronbRandomExpressionGenerator();

    public static void main(String[] args) {
        System.out.println("-------------------------------------------------------------------");
        System.out.println("Hello there! I am a random expression generator for Lukavronb logic.");
    ...
    private static void outputGeneratedExpressions() throws IOException, RecognitionException{
        ...
        for (int i = 0; i < g.valuationTimesToRun; i++){
            while ((outputFile = new File(outputPath + "/Lukavronb_" + fileIndex + ".mtl")).exists()){
                fileIndex++;
            }
            ...
            LukavronbProblemAnalyzer expressionAnalyzer = new LukavronbProblemAnalyzer(expressionStream);
    ...
    public LukavronbRandomExpressionGenerator() {
        super();
    }

    public LukavronbRandomExpressionGenerator(LukavronbObjectFactory factory) {
        super();
    ...
    public Lukavronb_valuation valuation(){
    ...
    private Lukavronb_valuation valuation(int d){
    ...
    public void set_valuationVariables(Collection<Lukavronb_valuationVariable> vars){
        if(vars == null) return;
        valuationVariablesSize = vars.size();
        valuationVariables = new String[valuationVariablesSize];
        Lukavronb_valuationVariable[] vv = (Lukavronb_valuationVariable[]) vars.toArray();
    ...
    protected final Lukavronb_valuationVariable valuationVariable(){
    ...
    public Lukavronb_formula formula(){
    ...
    private Lukavronb_formula formula(int d){
    ...
    public void set_formulaVariables(Collection<Lukavronb_formulaVariable> vars){
        if(vars == null) return;
        formulaVariablesSize = vars.size();
        formulaVariables = new String[formulaVariablesSize];
        Lukavronb_formulaVariable[] vv = (Lukavronb_formulaVariable[]) vars.toArray();
    ...
    protected final Lukavronb_formulaVariable formulaVariable(){
