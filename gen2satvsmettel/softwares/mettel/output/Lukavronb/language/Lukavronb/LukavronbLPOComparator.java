...
public class LukavronbLPOComparator implements Comparator<LukavronbAbstractExpression>{
    ...
    public int compare(LukavronbAbstractExpression e0, LukavronbAbstractExpression e1){
        ...
        if(e0 instanceof LukavronbAbstractVariable){
            if(e1 instanceof LukavronbAbstractVariable){ return e0.id() - e1.id(); }
            return -1;
        }else{
            if(e1 instanceof LukavronbAbstractVariable){ return 1; }
        }
