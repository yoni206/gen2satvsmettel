 ...
 */
package Lukavrona.language.Lukavrona.test;
...
public class LukavronaParserTest extends TestCase{

    final static String inFile = "test/examples/Lukavrona/input";
    final static String outFile = "test/examples/Lukavrona/output";
    public void testParser() throws IOException, RecognitionException{
        CommonTokenStream tokens = new CommonTokenStream();
        CharStream in = new ANTLRFileStream(inFile);
        LukavronaLexer lexer = new LukavronaLexer(in);
        ...
        for(Lukavrona_valuation e:list){
            b.append(e);
        ...
        tokens.setTokenSource(lexer);
        ArrayList<Lukavrona_valuation> list0 = new ArrayList<Lukavrona_valuation>();
        ...
        for(int i = 0; i < SIZE; i++){
            for(int j = i + 1; j < SIZE; j++){
                ...
                LukavronaSubstitution s = list.get(i).match(list.get(j));
