...
public class Lukavrona_conjunction_formula extends LukavronaAbstractExpression implements Lukavrona_formula{
    ...
    public Lukavrona_conjunction_formula(Lukavrona_formula e0, Lukavrona_formula e1, LukavronaObjectFactory f){
        super(f);
        int l = 1;
        this.e0 = e0;
        l += e0.length();
    ...
    public boolean match(LukavronaExpression e, LukavronaSubstitution s){
        if(!(e instanceof Lukavrona_conjunction_formula)){ return false;}
        final Lukavrona_conjunction_formula ee = (Lukavrona_conjunction_formula)e;
        return e0.match(ee.e0, s) && e1.match(ee.e1, s);
    }

    public LukavronaExpression substitute(LukavronaSubstitution s){
        return factory.create_conjunction_formula((Lukavrona_formula)e0.substitute(s), (Lukavrona_formula)e1.substitute(s));
    }

    public LukavronaExpression rewrite(LukavronaReplacement s){
        LukavronaExpression e = s.get_formula(this);
        if(e != null){ return e; }
        final Lukavrona_formula ee = factory.create_conjunction_formula((Lukavrona_formula)e0.rewrite(s), (Lukavrona_formula)e1.rewrite(s));
        e = s.get_formula(ee);
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof Lukavrona_conjunction_formula)){ return false; }
        Lukavrona_conjunction_formula e = (Lukavrona_conjunction_formula) o;
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof Lukavrona_conjunction_formula)){ return PRIORITY - ((LukavronaAbstractExpression)e).priority(); }
        Lukavrona_conjunction_formula ee = (Lukavrona_conjunction_formula) e;
        int result = 0;
