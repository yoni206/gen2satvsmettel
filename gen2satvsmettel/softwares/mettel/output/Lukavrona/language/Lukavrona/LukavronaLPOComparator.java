...
public class LukavronaLPOComparator implements Comparator<LukavronaAbstractExpression>{
    ...
    public int compare(LukavronaAbstractExpression e0, LukavronaAbstractExpression e1){
        ...
        if(e0 instanceof LukavronaAbstractVariable){
            if(e1 instanceof LukavronaAbstractVariable){ return e0.id() - e1.id(); }
            return -1;
        }else{
            if(e1 instanceof LukavronaAbstractVariable){ return 1; }
        }
