...
valuations
[Collection<Lukavrona_valuation> a0]
:
(
 (
  (e0 = valuation
...
;
valuationVariable
returns [Lukavrona_valuation r0]
@after{
...
;
formulas
[Collection<Lukavrona_formula> a0]
:
(
 (
  (e0 = formula
...
;
expressions
returns [ArrayList<LukavronaExpression> r0]
@init{
...
;
expression
returns [LukavronaExpression r0]
:
(
