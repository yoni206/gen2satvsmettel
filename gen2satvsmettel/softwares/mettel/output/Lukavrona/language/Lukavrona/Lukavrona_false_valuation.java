...
public class Lukavrona_false_valuation extends LukavronaAbstractExpression implements Lukavrona_valuation{

    static final int PRIORITY = 2;
    private final int LENGTH;
    protected Lukavrona_formula e0 = null;

    public Lukavrona_false_valuation(Lukavrona_formula e0, LukavronaObjectFactory f){
        super(f);
        int l = 1;
        this.e0 = e0;
        l += e0.length();
    ...
    public boolean match(LukavronaExpression e, LukavronaSubstitution s){
        if(!(e instanceof Lukavrona_false_valuation)){ return false;}
        final Lukavrona_false_valuation ee = (Lukavrona_false_valuation)e;
        return e0.match(ee.e0, s);
    }

    public LukavronaExpression substitute(LukavronaSubstitution s){
        return factory.create_false_valuation((Lukavrona_formula)e0.substitute(s));
    }

    public LukavronaExpression rewrite(LukavronaReplacement s){
        LukavronaExpression e = s.get_valuation(this);
        if(e != null){ return e; }
        final Lukavrona_valuation ee = factory.create_false_valuation((Lukavrona_formula)e0.rewrite(s));
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof Lukavrona_false_valuation)){ return false; }
        Lukavrona_false_valuation e = (Lukavrona_false_valuation) o;
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof Lukavrona_false_valuation)){ return PRIORITY - ((LukavronaAbstractExpression)e).priority(); }
        Lukavrona_false_valuation ee = (Lukavrona_false_valuation) e;
        int result = 0;
