...
public class LukavronaTableauProver{
    ...
    public static void main(String[] args) {
        System.out.println("-------------------------------------------------------------------");
        System.out.println("Hello there! I am an automated tableau prover for Lukavrona logic.");
    ...
    throws IOException, RecognitionException{
        CharStream tin = (path == null)?
            new ANTLRInputStream(LukavronaTableauProver.class.getResourceAsStream("calculus")):
