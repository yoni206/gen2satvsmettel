 ...
 */
package Lukavron.tableau.Lukavron.test;
...
public class LukavronTableauTest extends TestCase{

    final static String tableauFile = "test/examples/Lukavron/tableau";
    final static String inDir = "test/examples/Lukavron/problems";

    public void testTableau() throws IOException, RecognitionException{
        CommonTokenStream tokens = new CommonTokenStream();
        CharStream tin = new ANTLRFileStream(tableauFile);
        LukavronLexer lexer = new LukavronLexer(tin);
        ...
        System.out.println();
        System.out.println("----------------------------------------------------");
        System.out.print("Reading tableau calculus for Lukavron...");
        ...
        System.out.println("----------------------------------------------------");
        System.out.println("Testing tableau algorithm for Lukavron");
        System.out.print("----------------------------------------------------");
