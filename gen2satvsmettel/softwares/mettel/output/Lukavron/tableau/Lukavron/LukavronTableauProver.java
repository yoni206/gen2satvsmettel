...
public class LukavronTableauProver{
    ...
    public static void main(String[] args) {
        System.out.println("-------------------------------------------------------------------");
        System.out.println("Hello there! I am an automated tableau prover for Lukavron logic.");
        ...
        try{
            ...
            MettelTableauObjectFactory tfactory = new LukavronTableauObjectFactory();
    ...
    throws IOException, RecognitionException{
        CharStream tin = (path == null)?
            new ANTLRInputStream(LukavronTableauProver.class.getResourceAsStream("calculus")):
