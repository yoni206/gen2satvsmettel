...
public class Lukavron_false_valuation extends LukavronAbstractExpression implements Lukavron_valuation{

    static final int PRIORITY = 2;
    private final int LENGTH;
    protected Lukavron_formula e0 = null;

    public Lukavron_false_valuation(Lukavron_formula e0, LukavronObjectFactory f){
        super(f);
        int l = 1;
        this.e0 = e0;
        l += e0.length();
    ...
    public boolean match(LukavronExpression e, LukavronSubstitution s){
        if(!(e instanceof Lukavron_false_valuation)){ return false;}
        final Lukavron_false_valuation ee = (Lukavron_false_valuation)e;
        return e0.match(ee.e0, s);
    }

    public LukavronExpression substitute(LukavronSubstitution s){
        return factory.create_false_valuation((Lukavron_formula)e0.substitute(s));
    }

    public LukavronExpression rewrite(LukavronReplacement s){
        LukavronExpression e = s.get_valuation(this);
        if(e != null){ return e; }
        final Lukavron_valuation ee = factory.create_false_valuation((Lukavron_formula)e0.rewrite(s));
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof Lukavron_false_valuation)){ return false; }
        Lukavron_false_valuation e = (Lukavron_false_valuation) o;
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof Lukavron_false_valuation)){ return PRIORITY - ((LukavronAbstractExpression)e).priority(); }
        Lukavron_false_valuation ee = (Lukavron_false_valuation) e;
        int result = 0;
