...
import Lukavron.language.Lukavron.Lukavron_valuationVariable;
import Lukavron.language.Lukavron.Lukavron_formula;
import Lukavron.language.Lukavron.Lukavron_formulaVariable;

import Lukavron.language.Lukavron.LukavronObjectFactory;
...
public class LukavronRandomExpressionGenerator implements LukavronExpressionGenerator{
    ...
    private static LukavronRandomExpressionGenerator g = new LukavronRandomExpressionGenerator();

    public static void main(String[] args) {
        System.out.println("-------------------------------------------------------------------");
        System.out.println("Hello there! I am a random expression generator for Lukavron logic.");
    ...
    private static void outputGeneratedExpressions() throws IOException, RecognitionException{
        ...
        for (int i = 0; i < g.valuationTimesToRun; i++){
            while ((outputFile = new File(outputPath + "/Lukavron_" + fileIndex + ".mtl")).exists()){
                fileIndex++;
            }
            ...
            LukavronProblemAnalyzer expressionAnalyzer = new LukavronProblemAnalyzer(expressionStream);
    ...
    public LukavronRandomExpressionGenerator() {
        super();
    }

    public LukavronRandomExpressionGenerator(LukavronObjectFactory factory) {
        super();
    ...
    public Lukavron_valuation valuation(){
    ...
    private Lukavron_valuation valuation(int d){
    ...
    public void set_valuationVariables(Collection<Lukavron_valuationVariable> vars){
        if(vars == null) return;
        valuationVariablesSize = vars.size();
        valuationVariables = new String[valuationVariablesSize];
        Lukavron_valuationVariable[] vv = (Lukavron_valuationVariable[]) vars.toArray();
    ...
    protected final Lukavron_valuationVariable valuationVariable(){
    ...
    public Lukavron_formula formula(){
    ...
    private Lukavron_formula formula(int d){
    ...
    public void set_formulaVariables(Collection<Lukavron_formulaVariable> vars){
        if(vars == null) return;
        formulaVariablesSize = vars.size();
        formulaVariables = new String[formulaVariablesSize];
        Lukavron_formulaVariable[] vv = (Lukavron_formulaVariable[]) vars.toArray();
    ...
    protected final Lukavron_formulaVariable formulaVariable(){
