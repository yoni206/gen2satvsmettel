...
valuations
[Collection<Lukavron_valuation> a0]
:
(
 (
  (e0 = valuation
...
;
formulas
[Collection<Lukavron_formula> a0]
:
(
 (
  (e0 = formula
...
;
expressions
returns [ArrayList<LukavronExpression> r0]
@init{
